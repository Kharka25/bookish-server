...
describe('User Registration', () => {
  ...
  const userType_invalid = 'userType must be user or author';
  const userType_null = 'userType is required!';
  ...
  it.each`
    ...
    ${'userType'} | ${'auth'}          | ${userType_invalid}
    ${'userType'} | ${null}            | ${userType_null}
  `(
